...
Stream from 2 uuts for 2000 buffers
    ...
    ./HAPI/hts_multistream.py --nbuffers=2000 acq2106_133 acq2106_176

Stream each site different port:

    ./HAPI/hts_multistream.py ---map=133:A:1/133:B:2 acq2106_133

Stream for 1hr while checking spad:

    ./HAPI/hts_multistream.py --spad=1,8,1 --secs=3600 --check=1 acq2206_009
...
def dry_run(args, uut_collection):
    if args.verbose > 0:
        print("new style Stream.get_stream_conns {}".format(Stream.get_config()))#####Stream here
