\hypertarget{md_README_autotoc_md13}{}\doxysubsection{1. Hardware}\label{md_README_autotoc_md13}
A\+H\+F\+B\+A404 is a P\+C\+I-\/express Gen2 4 lane card to fit standard PC enclosure On the front panel\+: 4x\+S\+FP marked A,B,C,D

A\+F\+H\+B\+A404 is used to connect 1 to 4 A\+C\+Q2106 units to a H\+O\+ST PC, establishing a fiber-\/optic link that may be used in one of two ways\+:\hypertarget{md_README_autotoc_md14}{}\doxysubsubsection{1.\+1 H\+T\+S High Throughput Stream}\label{md_README_autotoc_md14}
...
See R\+E\+A\+D\+M\+E.\+A\+C\+Q2106.\+H\+TS and S\+T\+R\+E\+A\+M/ for details.\hypertarget{md_README_autotoc_md15}{}\doxysubsubsection{1.\+2 L\+L\+C Low Latency Control}\label{md_README_autotoc_md15}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md16}{}\doxysubsection{2. Device driver}\label{md_README_autotoc_md16}
Download from git\+: 
\begin{DoxyPre}
mkdir PROJECTS
cd PROJECTS
...
\#\hypertarget{md_README_autotoc_md17}{}\doxysection{3. Check A\+F\+H\+B\+A404 firmware}\label{md_README_autotoc_md17}
...
\end{DoxyPre}
 If your A\+F\+H\+B\+A404 or A\+C\+Q2106 does N\+OT meet the requirements, please contact D-\/\+T\+A\+CQ for support.\hypertarget{md_README_autotoc_md18}{}\doxysubsection{4. Check Connected Devices}\label{md_README_autotoc_md18}
